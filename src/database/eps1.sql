...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2025 at 10:57 AM
...
(26, 16, 'User Logout: Yongzon', '2025-04-02 08:05:07'),
(27, 16, 'User Login: Yongzon', '2025-04-02 08:05:48'),
(28, 16, 'Deleted Employee: Miguel Zion Yongzon', '2025-04-02 08:06:09'),
(29, 16, 'User Login: Yongzon', '2025-04-02 08:11:45'),
(30, 16, 'Deleted Department: Admin', '2025-04-02 08:11:51'),
(31, 16, 'Deleted Department: Admin', '2025-04-02 08:12:23'),
(32, 16, 'Deleted Department: Admin', '2025-04-02 08:15:44'),
(33, 16, 'User Login: Yongzon', '2025-04-02 08:21:17'),
(34, 16, 'User Login: Yongzon', '2025-04-02 08:33:24'),
(35, 16, 'Created a new Employee: 18', '2025-04-02 08:33:56'),
(36, 16, 'Deleted Department: PC Tech', '2025-04-02 08:34:16'),
(37, 16, 'Deleted Employee: Angel Mae Segismar', '2025-04-02 08:35:12'),
(38, 16, 'Deleted Employee: Angel Mae Segismar', '2025-04-02 08:35:22'),
(39, 16, 'Deleted Department: Admin', '2025-04-02 08:35:28'),
(40, 16, 'Deleted Department: PC Tech', '2025-04-02 08:35:33'),
(41, 16, 'Created a Departmen: IT', '2025-04-02 08:35:44');
...
--
ALTER TABLE `tbl_logs`
  ADD CONSTRAINT `tbl_logs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tbl_admin` (`u_id`);
